  ...
  return (
    <>
      ...
      {mapVisible ? (
              ...
              venues!.map((venue) => {
                ...
                return (
                  <Marker
                    ...
                    coordinate={{
                      latitude: venue!.locations[0].latitude,
                      longitude: venue!.locations[0].longitude,
                    }}
                  >
        ...
        <List venues={venues} onPress={() => console.log("Venue pressed")} />
      )}
      <FilterScreen
